...
<img class="ui tiny left circular floated image" src="../images/actions.jpg"> It included research that demonstrated those skills rather than just trying to use words to explain. 
